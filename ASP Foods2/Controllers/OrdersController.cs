...
namespace ASP_Foods2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientId,ProductId,Quantity,DateAdded")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,ProductId,Quantity,DateAdded")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
